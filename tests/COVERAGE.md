...
Runs recorded: **241** across **33** tests.
...
| `picard` | `implicit` | `bdf2_on_V` | 2 | **0** | 1 |
...
| `Newton_Jacobian_+_contract` | equilibrium | anderson,newton | be_volume,tr_bdf2 | adaptive,continuation | active_set,explicit,implicit | 1 | 0 | 1 |
| `active-set_collector-indep` | equilibrium | anderson | tr_bdf2 | adaptive | implicit | 1 | 0 | 1 |
...
| `combination_sweep` | equilibrium,transient | anderson,newton,picard | bdf2_on_V,be_volume,tr_bdf2 | adaptive,continuation | active_set,explicit,implicit,off | 1 | 0 | 1 |
...
| `flicker_2:_evap_discontinuity` | equilibrium | anderson | tr_bdf2 | adaptive | implicit | 0 | 0 | 1 |
...
| `multi-lake_stages_vs_dt` | equilibrium | anderson | tr_bdf2 | adaptive | active_set,implicit | 1 | 0 | 4 |
...
| `runoff_collector_selector` | equilibrium | anderson | tr_bdf2 | adaptive | active_set,explicit,extended_soil,implicit,off | 0 | 0 | 1 |
| `runoff_gathering_(wtd=0)` | equilibrium | anderson | tr_bdf2 | adaptive | implicit,off | 0 | 0 | 1 |
...
| `taper_determinism+smooth` | equilibrium | anderson | tr_bdf2 | adaptive | active_set,explicit | 0,1 | 0 | 1,4 |
| `water-budget_closure_(schemes)` | equilibrium | anderson,newton,picard | bdf2_on_V,be_volume,tr_bdf2 | adaptive,continuation | active_set,explicit,implicit,off | 1 | 1 | 1 |
...
|---|---|---|---|---|---|
| **anderson** | 114 | 19 | 1 | 26 | 21 |
| **newton** | 16 | 8 |   | 8 | 6 |
| **picard** | by design | 9 |   | 7 | 6 |
...
| **be_volume** | 14 | 12 |   | 10 | 8 |
| **tr_bdf2** | 99 | 15 | 1 | 24 | 19 |

### dtctl x collector

| dtctl \ collector | active_set | explicit | extended_soil | implicit | off |
|---|---|---|---|---|---|
| **adaptive** | 111 | 29 | 1 | 29 | 27 |
...
|---|---|---|---|---|---|
| **equilibrium** | 105 | 24 | 1 | 31 | 23 |
| **test** | 2 |   |   |   |   |
| **transient** | 23 | 12 |   | 10 | 10 |
...
- `dtctl=fixed` x `collector=explicit`
- `dtctl=fixed` x `collector=extended_soil`
- `dtctl=fixed` x `collector=off`
