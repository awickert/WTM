...
WTM_DECLARED_SUITES="fsm_conservation xrank_adaptive log_schema direct_to_runoff storage_equivalence adaptive_restart fsm_consistency variable_porosity"
