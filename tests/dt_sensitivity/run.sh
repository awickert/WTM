...
print(f"  DT-INDEPENDENT : active-set        max|ΔV(1yr) - ΔV(1/4 yr)| = {act:.3e} m water  (tol DT_TOL={dt_tol})")
print(f"  BITES          : implicit siphon   max|ΔV(1yr) - ΔV(1/4 yr)| = {leg:.3e} m water  (min BITE_MIN={bite})")
