...
#
# Schemes: cc (backward-Euler baseline), tr (TR-BDF2), trtbar (tr + Tbar; the clean-room laptop tests showed
# Tbar is a stiff-step tool that EXTENDS the TR-BDF2 stability ceiling dt8->dt10 -- worth testing at MSI
# parallel scale under FSM), bdf2v (BDF2-on-V, the other 2nd-order). Dry -20% P-ET step (telling direction).
#
...
#   WTM_METHODS="cc tr trtbar bdf2v" python3 dtsweep_speed.py results/algo/transient/bench_fsm dry 2
#   WTM_DTS="0.5 1 2 4 8 16 32" WTM_METHODS="cc tr trtbar bdf2v" python3 dtsweep_speed.py results/algo/transient/bigdt_fsm dry 32 tr 0.5
#
...
echo "submitted 8 FSM-on jobs (cc/tr/trtbar/bdf2v x {bench_fsm 2wk, bigdt_fsm 32wk})"
