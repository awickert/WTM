...
| ~~`fsm_continuous`~~ | ~~1~~ | **NOT A DECISION -- the row was stale.** Three live test invocations, and #40 made it COMPOSE with active_set rather than be superseded by it. It survives, so under D it needs a config key |
