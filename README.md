...
**364 runs** across **199 tests**. **36** distinct (solver, collector, integrator) combinations are exercised; of those **35** run in both equilibrium and transient and **1** are equilibrium-only. Full detail, every pairwise crossing and the gap list: [`tests/COVERAGE.md`](tests/COVERAGE.md).
