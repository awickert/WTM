...
**255 runs** across **34 tests**. **25** distinct (solver, collector, integrator) combinations are exercised; of those **22** run in both equilibrium and transient and **1** are equilibrium-only. Full detail, every pairwise crossing and the gap list: [`tests/COVERAGE.md`](tests/COVERAGE.md).
...
| `anderson` | `active_set` | `tr_bdf2` | 90 | 2 | 13 |
