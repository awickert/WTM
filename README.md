...
**144 runs** across **30 tests**; **31** reachable combinations are untested. Full detail, including every crossing and the gap list, is in [`tests/COVERAGE.md`](tests/COVERAGE.md).
...
|---|---|---|---|---|---|
| **`bdf2_on_V`** | 5 | 2 | 1 | 1 | **0** |
| **`be_secant`** | n/a | 10 | 16 | 20 | 7 |
| **`be_volume`** | 67 | **0** | 2 | **0** | **0** |
| **`tr_bdf2`** | 12 | **0** | 1 | **0** | **0** |
