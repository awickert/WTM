...
**354 runs** across **45 tests**. **28** distinct (solver, collector, integrator) combinations are exercised; of those **23** run in both equilibrium and transient and **4** are equilibrium-only. Full detail, every pairwise crossing and the gap list: [`tests/COVERAGE.md`](tests/COVERAGE.md).
