...
**345 runs** across **38 tests**. **27** distinct (solver, collector, integrator) combinations are exercised; of those **23** run in both equilibrium and transient and **3** are equilibrium-only. Full detail, every pairwise crossing and the gap list: [`tests/COVERAGE.md`](tests/COVERAGE.md).
