...
**272 runs** across **36 tests**. **25** distinct (solver, collector, integrator) combinations are exercised; of those **22** run in both equilibrium and transient and **1** are equilibrium-only. Full detail, every pairwise crossing and the gap list: [`tests/COVERAGE.md`](tests/COVERAGE.md).

**Which combinations are tested, and at which run type**

| solver | collector | integrator | `equilibrium` | `test` | `transient` |
|---|---|---|---|---|---|
| `anderson` | `active_set` | `bdf2` | 10 | **0** | 5 |
| `anderson` | `active_set` | `tr_bdf2` | 104 | 2 | 15 |
| `anderson` | `explicit` | `bdf2` | 1 | **0** | 1 |
...
| `anderson` | `implicit` | `bdf2` | 1 | **0** | 1 |
| `anderson` | `implicit` | `tr_bdf2` | 21 | **0** | 3 |
| `anderson` | `off` | `bdf2` | 1 | **0** | 1 |
